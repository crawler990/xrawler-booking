...
import { MPESA, consumerKey, consumerSecret, mpesaAccessTokenUrl, DTOMPESA, mpesaBusinessShortCode, passKey, TransactionType, callBackUrl, mpesaSTKPushUrl, securityCredential, mpesaQueueTimeOutUrl, mpesaResultUrl, mpesaReversalUrl, mpesaTransactionStatusUrl } from '../mpesa.model';
